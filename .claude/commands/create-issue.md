...
Если из описания priority неоднозначен — спроси одним вопросом, не угадывай критичность.
...
Перед созданием покажи пользователю **title + labels + полное тело** и дождись подтверждения. Никогда не создавай issue молча.
