...
- Runtime validation is opt-in via `@real-router/validation-plugin` — core ships with structural guards and five invariant guards only (subscribe, navigateToNotFound, start, claimContextNamespace, channel guard #1572)
