...
See [`examples/desktop/tauri/react-navigation`](../../tauri/react-navigation) for the Tauri-specific compatibility matrix and trade-offs.
...
- [`examples/desktop/electron/react`](../react) — browser-plugin + `app://`
- [`examples/desktop/electron/react-hash`](../react-hash) — hash-plugin + `file://`
- [`examples/desktop/tauri/react-navigation`](../../tauri/react-navigation) — same plugin in Tauri, with OS requirements
