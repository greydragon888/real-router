...
const DEFAULTS: PageMeta = {
  title: "Real-Router Preact SSR Example",
  description:
    "Server-side rendering with Real-Router and Preact 10 via Vite + Express.",
  canonical: SITE_ORIGIN,
  ogTitle: "Real-Router Preact SSR Example",
  ogDescription:
    "Server-side rendering with Real-Router and Preact 10 via Vite + Express.",
};
...
export function getMetaForState(state: {
  ...
  switch (state.name) {
    case "home": {
      return {
        title: "Home — Real-Router Preact SSR",
        description: "Welcome to the Real-Router Preact SSR example.",
        canonical: abs("/"),
        ogTitle: "Home",
        ogDescription: "Welcome to the Real-Router Preact SSR example.",
      };
    }
    case "users": {
    ...
    case "users.profile": {
      ...
      return {
        title: `${name} — Real-Router Preact SSR`,
    ...
    case "users.profile.posts": {
      ...
      return {
        title: `${name}'s posts — Real-Router Preact SSR`,
    ...
    case "dashboard": {
      return {
        title: "Dashboard — Real-Router Preact SSR",
    ...
    case "admin": {
      return {
        title: "Admin — Real-Router Preact SSR",
