  ...
  return (
    <div ref={ref}>
      ...
      <p>
        ...
        from <code>@real-router/preact</code>, both of which subscribe to
      ...
      <p>
        ...
        ghost exits) needs shared state — module-level variables, Context, or
        a custom event bus — because each page&apos;s hook only sees its own
        lifecycle.
      </p>
    </div>
  );
