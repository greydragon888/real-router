  ...
  return (
    <div ref={ref}>
      ...
      <p>
        ...
        <code>useRouteEnter</code> from <code>@real-router/solid</code>, both of
      ...
      <ol>
        <li>
          ...
          <code>fade-out</code> class runs, the hook's Promise resolves when{" "}
          <code>Element.getAnimations() + .finished</code> settle, the router
          activates About, and About's <code>fade-in</code> plays via its own{" "}
      ...
      <p>
        ...
        ghost exits) needs shared state — module-level variables or a custom
        event bus — because each page's hook only sees its own lifecycle.
      </p>
    </div>
  );
}
