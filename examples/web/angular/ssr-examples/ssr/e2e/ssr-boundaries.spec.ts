...
/**
 * Dogfooding scenario for `<client-only>` + `<server-only>` from
 * `@real-router/angular`. Verifies the SSR-vs-post-hydration contract
 * end-to-end.
 */
test.describe("SSR boundaries (<client-only> + <server-only>)", () => {
