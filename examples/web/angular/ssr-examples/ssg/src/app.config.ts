 ...
 * Browser-only — verifies the post-hydration loader skip via TransferState
 * bridge (#599) works on SSG-prerendered HTML loaded as static files.
 * Generated HTML carries `<script id="ng-state">` from the SSG server pass;
 * the client bootstrap consumes it through the same bridge that powers
 * runtime SSR.
 */
