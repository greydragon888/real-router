  ...
  template: `
    <div>
      ...
      <p>
        ...
        the browser has captured the old DOM snapshot, so the URL in the address
      ...
      <ol>
        ...
        <li>
          ...
          card — only that thumb keeps its
          <code>view-transition-name</code> (set via
          <code>html.vt-hero-morph[data-vt-hero-id]</code>), then FLIP-morphs
        ...
        <li>
          ...
          transitions are skipped, the last click wins, no stale animations
          leak.
        </li>
        <li>
        ...
        <li>
          ...
          Safari 18+, and Firefox 147+ — older browsers silently skip
          animations.
        </li>
      </ol>
      ...
      <p>
        ...
        <code
          >provideRealRouter(router, &#123; viewTransitions: true &#125;)</code
        ...
        classes on <code>&lt;html&gt;</code> from
        <code>subscribeLeave</code> and lets CSS gate
        <code>view-transition-name</code> accordingly.
      </p>
      <p>
