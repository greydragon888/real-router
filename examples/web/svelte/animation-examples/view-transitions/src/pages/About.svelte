<div>
  <h1>About</h1>
  <p>
    This example uses <code>@real-router/svelte</code> with the
  ...
  <ol>
    ...
    <li>
      Utility resolves the deferred via <code>setTimeout(0)</code>. Svelte 5
      runes flush on the microtask queue, which runs earlier than our
  ...
  <p>
    ...
    of the rendering pipeline, so it fires regardless of suppression. This is
    the one non-obvious detail of the whole design — see
