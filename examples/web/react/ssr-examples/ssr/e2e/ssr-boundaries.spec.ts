 ...
 * `@real-router/react`. Verifies the SSR-vs-post-hydration contract
 * end-to-end: server emits the SSR-side branch, client matches it on
 * first paint (no hydration mismatch), then a single post-mount swap
 * reveals the opposite branch.
 */
