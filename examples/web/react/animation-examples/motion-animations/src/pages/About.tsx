  ...
  return (
    <div>
      ...
      <p>
        ...
        <code>@real-router/react</code> with its own DOM recipe; pages stay
      ...
      <p>
        ...
        <code>@real-router/react</code>. Encapsulated, simpler mental model,
      ...
      <p>
        ...
        <code>useRouteExit</code> from <code>@real-router/react</code> with a
