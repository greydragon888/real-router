    ...
    <div>
      ...
      <ol>
        ...
        <li>
          ...
          React scheduler&apos;s <code>MessageChannel</code> tasks queue earlier
          than our timer, so the DOM is committed by the time our callback runs.
          Browser then captures the new snapshot and plays{" "}
