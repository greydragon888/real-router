...
import { Link, RouterErrorBoundary, useNavigator } from "@real-router/react";
  ...
  return (
    <div>
      ...
      <p>
        ...
        caught with <code>try/catch</code> (imperative) or{" "}
        <code>RouterErrorBoundary</code> (declarative), and also captured by the{" "}
