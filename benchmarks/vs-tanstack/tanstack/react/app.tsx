...
const itemsRoute = createRoute({
  ...
  path: "/items/$id",
  params: {
    parse: (params) => ({ ...params, id: normalizePage(params.id) }),
    stringify: (params) => ({ ...params, id: `${params.id}` }),
  },
  onEnter: noop,
  onStay: noop,
  onLeave: noop,
...
const contextRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/ctx/$id",
  beforeLoad: ({ params }) => ({ sectionSeed: Number(params.id) * 13 + 1 }),
