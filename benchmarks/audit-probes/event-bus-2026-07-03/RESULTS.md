...
Run: `cd benchmarks && NODE_OPTIONS='--conditions=@real-router/internal-source' npx tsx audit-probes/event-bus-2026-07-03/<probe>.ts` (src); without `--conditions` — dist. All three new probes ran against BOTH — identical verdicts.
