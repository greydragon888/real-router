...
Run: `cd benchmarks && NODE_OPTIONS='--conditions=@real-router/internal-source' npx tsx audit-probes/clone-router-2026-07-03/<probe>.ts` (src); same command without `--conditions` runs against dist. probe-07 additionally needs `--expose-gc`.
