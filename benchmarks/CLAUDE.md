...
- Full rationale + the empirically-verified gotchas (playwright no-install-script, `pnpm exec` root-vs-benchmarks, O-8×provenance mtime) → IMPLEMENTATION_NOTES «Cross-router benchmarks in CI».
