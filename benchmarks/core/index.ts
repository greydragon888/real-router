...
const SECTION_IMPORTS: Record<number, string[]> = {
  ...
  2: [
    "./02-path-operations/2.1-buildPath.bench",
    "./02-path-operations/2.2-matchPath.bench",
    "./02-path-operations/2.3-setRootPath.bench",
    "./02-path-operations/2.4-edge-cases.bench",
  ],
  3: [
    "./03-current-state/3.1-comparing.bench",
    "./03-current-state/3.2-creating.bench",
    "./03-current-state/3.3-building.bench",
    "./03-current-state/3.4-forward.bench",
    "./03-current-state/3.5-edge-cases.bench",
  ],
  4: [
    "./04-stress-testing/4.1-high-load-sequential.bench",
    "./04-stress-testing/4.2-route-scaling.bench",
  ],
};
