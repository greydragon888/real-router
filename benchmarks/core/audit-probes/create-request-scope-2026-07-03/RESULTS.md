...
Run: `cd benchmarks && NODE_OPTIONS='--conditions=@real-router/internal-source' npx tsx core/audit-probes/create-request-scope-2026-07-03/<probe>.ts` (src); without `--conditions` — dist (identical verdicts).
