...
const SVELTE_BLURBS = {
  ...
  "wide-config": "Navigate into a flat 1000-route table — **the matcher crossover, and real-router's clearest win in this cohort.** real-router's segment trie stays FLAT (total ~0.37–0.41 across @10/@100/@1000; script 0.314 @1000), while **sv-router degrades O(N)** (0.293 → 0.767 @1000 — it sorts + scans its route-key list per nav, NOT a segment trie) and mateo-router carries a high flat floor (~0.83). **real-router WINS @1000** (0.370 < sv-router 0.767 < mateo 0.831) on total — the structural trie advantage holds in Svelte (as in React/Vue, unlike the Solid cohort where @solidjs/router was also flat).",
