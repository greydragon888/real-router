import { createRouter, errorCodes, RouterError } from "router6";
import { loggerPluginFactory as loggerPlugin } from "router6-plugin-logger";
...
import { createSafeBrowser } from "../../modules/browser";
import { noop } from "../../modules/utils";

import type { Browser, HistoryState } from "../../modules/types";
import type { Router, State, Unsubscribe } from "router6";
  ...
  describe("Plugin Lifecycle", () => {
    describe("Listener Management", () => {
      it("prevents repeated start", () => {
        ...
        // Router6 throws error on repeated start
        const done = vi.fn();
