...
// ============================================
// ESLint 9.39+ Configuration for solid-real-router
// Based on react-real-router config with Solid-specific adaptations:
// - No @eslint-react (React-specific JSX/component analysis)
// - No react-hooks (Solid doesn't use React hooks)
...
export default tsEslint.config(
  ...
  // ============================================
  // Using flat/dom for Solid (no React-specific rules)
  {
    files: ["**/*.test.tsx"],
