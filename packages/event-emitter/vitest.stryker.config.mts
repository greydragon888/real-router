...
/**
 * Vitest configuration for Stryker mutation testing (event-emitter)
 *
...
export default defineConfig({
  ...
  // Functional tests import via relative paths (../../src/EventEmitter.js), which
  // already hit the sandbox-mutated src — this self-alias is kept for parity with
  // the other stryker configs and future package-name imports.
  resolve: {
    alias: {
      "event-emitter": path.resolve(import.meta.dirname, "./src"),
    },
  },
