...
- [#2191](https://github.com/greydragon888/real-router/pull/2191) [`d347e0b`](https://github.com/greydragon888/real-router/commit/d347e0bb0c2997bfdf75ae45d87473089699e614) Thanks [@greydragon888](https://github.com/greydragon888)! - `v-link` honours the anchor's `target`, and `<Link target>` defers for every value but `_self` ([#1834](https://github.com/greydragon888/real-router/issues/1834))
