...
// ============================================
// ESLint 9.39+ Configuration for vue-real-router
// Based on preact-real-router config with Vue-specific adaptations:
// - No react-hooks plugin (Vue doesn't use React hooks)
// - All files are .ts (no .tsx, no .vue)
...
export default tsEslint.config(
  ...
  // ============================================
  // JSDOC CONFIGURATION FOR .ts FILES
  // ============================================
  {
  ...
  // ============================================
  // UNICORN CONFIGURATION FOR .ts FILES
  // ============================================
  {
    files: ["**/*.ts"],
    plugins: {
  ...
  // ============================================
  // PROMISE CONFIGURATION FOR .ts FILES
  // ============================================
  {
    files: ["**/*.ts"],
    plugins: {
  ...
  // ============================================
  // PRETTIER CONFIGURATION FOR .ts FILES
  // ============================================
  {
    files: ["**/*.ts"],
    plugins: {
  ...
  // ============================================
  // SONARJS CONFIGURATION FOR .ts FILES
  // ============================================
  {
    files: ["**/*.ts"],
    plugins: {
