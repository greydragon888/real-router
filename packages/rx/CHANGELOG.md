...
- [#2183](https://github.com/greydragon888/real-router/pull/2183) [`5957157`](https://github.com/greydragon888/real-router/commit/5957157cb9dcfdeae90da904ae540295fc635a72) Thanks [@greydragon888](https://github.com/greydragon888)! - A `Symbol.observable` polyfill imported after this package now reaches the prototype ([#2119](https://github.com/greydragon888/real-router/issues/2119))
...
- [#2118](https://github.com/greydragon888/real-router/pull/2118) [`ee95944`](https://github.com/greydragon888/real-router/commit/ee95944799505c41034bfc94707650b5e017cfc8) Thanks [@greydragon888](https://github.com/greydragon888)! - Install the TC39 interop member under a real key, never the string `"undefined"` ([#1739](https://github.com/greydragon888/real-router/issues/1739))
...
> ⚠ **Never published** — there is no `0.3.73` on npm and no git tag for it. The release run that allocated this number never reached the registry; the entries below ship in **0.3.74**.
...
> ⚠ **Never published** — there is no `0.3.61` on npm and no git tag for it. The release run that allocated this number never reached the registry; the entries below ship in **0.3.62**.
