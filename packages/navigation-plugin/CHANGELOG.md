...
- [#2232](https://github.com/greydragon888/real-router/pull/2232) [`7651712`](https://github.com/greydragon888/real-router/commit/7651712a7c77a9db5e19e445132c68baed637486) Thanks [@greydragon888](https://github.com/greydragon888)! - a superseded traverse no longer retires its successor's record ([#2067](https://github.com/greydragon888/real-router/issues/2067))
  ...
  ⚠ **[#1802](https://github.com/greydragon888/real-router/issues/1802) pulls the other way and stays satisfied.** There the record SURVIVES a
...
- [#2186](https://github.com/greydragon888/real-router/pull/2186) [`c3b5662`](https://github.com/greydragon888/real-router/commit/c3b566254822f5ac3e18c5e82734aea563947272) Thanks [@greydragon888](https://github.com/greydragon888)! - The shared browser sleeve reads the fragment slot once and snapshots nested bags ([#2141](https://github.com/greydragon888/real-router/issues/2141))
  ...
  **A restored entry's NESTED bags are snapshotted too.** [#1837](https://github.com/greydragon888/real-router/issues/1837) pinned the four
...
> ⚠ **Never published** — there is no `0.9.2` on npm and no git tag for it. The release run that allocated this number never reached the registry; the entries below ship in **0.9.3**.
...
> ⚠ **Never published** — there is no `0.8.27` on npm and no git tag for it. The release run that allocated this number never reached the registry; the entries below ship in **0.8.28**.
