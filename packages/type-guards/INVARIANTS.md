...
| 22  | isParams rejects circular references through arrays | Objects whose arrays contain back-references to parent objects are rejected. The `WeakSet` tracks all visited objects during the iterative validation walk.                                                                                                                                                              |
