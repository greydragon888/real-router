...
export default defineConfig({
  ...
  resolve: {
    alias: {
      // Main package - resolve to local src. The former search-params /
      // path-matcher packages are now internal layers under src/, reached by
      // tests via relative paths — no separate package aliases needed.
