...
describe("RouterError Circular References Properties", () => {
  ...
  describe("Complex circular references", () => {
    it("deepFreezeState handles multiple circular references", () => {
  ...
  describe("Immutability after freeze with circular references", () => {
    it("frozen State with circular references cannot be modified", () => {
      const params: Params = { foo: "bar" };
  ...
  describe("Edge cases", () => {
    it("deepFreezeState handles empty objects with circular references", () => {
