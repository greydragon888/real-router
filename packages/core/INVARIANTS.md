...
| 9   | Fires once, in order               | Every registered listener fires exactly once per leave, in registration order; unsubscribing K of N leaves exactly the remaining N−K firing. Property-verified in `tests/property/subscribe-leave.properties.ts`.                                                                  |
