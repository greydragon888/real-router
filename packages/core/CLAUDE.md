...
├── InFlightNavigation.ts      — the AbortController of the navigation in
│                                flight, one slot, one instance per router
