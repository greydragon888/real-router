...
> ⚠ **Never published** — there is no `0.18.40` on npm and no git tag for it. The release run that allocated this number never reached the registry; the entries below ship in **0.18.41**.
...
> ⚠ **Never published** — there is no `0.18.25` on npm and no git tag for it. The release run that allocated this number never reached the registry; the entries below ship in **0.18.26**.
...
- [#1587](https://github.com/greydragon888/real-router/pull/1587) [`cb6b507`](https://github.com/greydragon888/real-router/commit/cb6b507bcd93c6ba2736ae8ac0aa17090b247507) Thanks [@greydragon888](https://github.com/greydragon888)! - Adapt to the RFC-4 M2 params/search slot-shift ([#1548](https://github.com/greydragon888/real-router/issues/1548))
  ...
  The shared `navigateWithHash` / scroll-spy DOM helpers pass the query channel at
  navigate position 3 and options at position 4, matching core's new
  `navigate(name, params, search, opts)` signature.
