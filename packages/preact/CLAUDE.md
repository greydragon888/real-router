...
| `scrollRestoration`  | `ScrollRestorationOptions`         | `undefined` | Opt into scroll capture + restoration. Keyed by `state.path`, the form core prints the location in (#1923) — history entries at one URL share one bucket.                                                                                                                                                             |
