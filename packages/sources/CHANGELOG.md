...
> ⚠ **Never published** — there is no `0.14.21` on npm and no git tag for it. The release run that allocated this number never reached the registry; the entries below ship in **0.14.22**.
...
> ⚠ **Never published** — there is no `0.14.8` on npm and no git tag for it. The release run that allocated this number never reached the registry; the entries below ship in **0.14.9**.
...
- [#1887](https://github.com/greydragon888/real-router/pull/1887) [`821af3f`](https://github.com/greydragon888/real-router/commit/821af3f2f3f3696fe9612dc75cb38f07bf4018d2) Thanks [@greydragon888](https://github.com/greydragon888)! - fix: a non-string route name no longer shares a cache slot with a well-typed one ([#1881](https://github.com/greydragon888/real-router/issues/1881))
...
- [#1587](https://github.com/greydragon888/real-router/pull/1587) [`cb6b507`](https://github.com/greydragon888/real-router/commit/cb6b507bcd93c6ba2736ae8ac0aa17090b247507) Thanks [@greydragon888](https://github.com/greydragon888)! - Active-route sources carry the query (search) channel — RFC-4 M2 ([#1548](https://github.com/greydragon888/real-router/issues/1548))
...
- [#1587](https://github.com/greydragon888/real-router/pull/1587) [`cb6b507`](https://github.com/greydragon888/real-router/commit/cb6b507bcd93c6ba2736ae8ac0aa17090b247507) Thanks [@greydragon888](https://github.com/greydragon888)! - Correct the `stabilizeState` JSDoc reload example to the four-slot signature ([#1548](https://github.com/greydragon888/real-router/issues/1548))
