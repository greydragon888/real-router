...
- [#2224](https://github.com/greydragon888/real-router/pull/2224) [`abc5c11`](https://github.com/greydragon888/real-router/commit/abc5c11ca24cc9e445039593bbbfcc00c8f8a61b) Thanks [@greydragon888](https://github.com/greydragon888)! - `RouteUtils` no longer carries the static segment-tester facade ([#2209](https://github.com/greydragon888/real-router/issues/2209))
  ...
  The rest of the gap is [#2210](https://github.com/greydragon888/real-router/issues/2210)'s mechanism, not this one's: `endsWithSegment` and
