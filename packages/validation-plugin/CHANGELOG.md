...
- [#2567](https://github.com/greydragon888/real-router/pull/2567) [`9070564`](https://github.com/greydragon888/real-router/commit/9070564437c144bc26cff8a735f77ba467669004) Thanks [@greydragon888](https://github.com/greydragon888)! - `replace()` judges its batch as the whole new table, not against the table it replaces ([#2562](https://github.com/greydragon888/real-router/issues/2562))
...
- [#2533](https://github.com/greydragon888/real-router/pull/2533) [`039ca87`](https://github.com/greydragon888/real-router/commit/039ca877a545b73ed676bec0445306fdb614c27e) Thanks [@greydragon888](https://github.com/greydragon888)! - Every refusal builds through the raiser ([#2487](https://github.com/greydragon888/real-router/issues/2487))
...
- [#2389](https://github.com/greydragon888/real-router/pull/2389) [`45ee75f`](https://github.com/greydragon888/real-router/commit/45ee75f33840c239c5079b7d985275d42674b4e2) Thanks [@greydragon888](https://github.com/greydragon888)! - Follow core's validators onto facts ([#2382](https://github.com/greydragon888/real-router/issues/2382))
...
- [`c2b3ab7`](https://github.com/greydragon888/real-router/commit/c2b3ab76f43a17b9b14706fd834c27f4a4bdd09a) Thanks [@greydragon888](https://github.com/greydragon888)! - Teardown no longer nulls a validator slot it no longer holds ([#2339](https://github.com/greydragon888/real-router/issues/2339) §4 1b)
  ...
  ([#2059](https://github.com/greydragon888/real-router/issues/2059) / [#1929](https://github.com/greydragon888/real-router/issues/1929)).
  ...
  second writer it correctly nulled its own. [#2349](https://github.com/greydragon888/real-router/issues/2349) closed the neighbouring half —
...
- [#2365](https://github.com/greydragon888/real-router/pull/2365) [`8d39dd8`](https://github.com/greydragon888/real-router/commit/8d39dd879c92bc25b9a097707a7a1feb61d134fa) Thanks [@greydragon888](https://github.com/greydragon888)! - One router, one validator — a second registration is now refused ([#2349](https://github.com/greydragon888/real-router/issues/2349))
...
- [#2327](https://github.com/greydragon888/real-router/pull/2327) [`c9e141b`](https://github.com/greydragon888/real-router/commit/c9e141bf07026834ad5a36a49306a2bd15a3fd4f) Thanks [@greydragon888](https://github.com/greydragon888)! - Check `revalidate` like every other boolean navigation option, and bind every name table to core

  `isNavigationOptions` walks a hand-written list of five fields while its own docblock promised "all optional boolean fields". Core's `NavigationOptions` has six: `revalidate` arrived with [#1201](https://github.com/greydragon888/real-router/issues/1201) and nothing here said so, so the guard admitted ANY value for it — a string, an object — while rejecting a non-boolean on each of its five siblings. The neighbouring pin enumerated the same five the list did, which is why it could not notice.
...
- [#2280](https://github.com/greydragon888/real-router/pull/2280) [`f282c35`](https://github.com/greydragon888/real-router/commit/f282c355fd100db3fa2b6b8286d72cd8cd9d602a) Thanks [@greydragon888](https://github.com/greydragon888)! - A refused `setDependencies` leaves the store untouched ([#2253](https://github.com/greydragon888/real-router/issues/2253))
...
- [#2236](https://github.com/greydragon888/real-router/pull/2236) [`1652be9`](https://github.com/greydragon888/real-router/commit/1652be93101a61d6c568226b7bbc9706a9ab1683) Thanks [@greydragon888](https://github.com/greydragon888)! - a guard registered under a name the tree does not carry is reported at start() ([#2049](https://github.com/greydragon888/real-router/issues/2049))
...
- [#2220](https://github.com/greydragon888/real-router/pull/2220) [`33e5ace`](https://github.com/greydragon888/real-router/commit/33e5ace362f3c719b33a0ce8c522f763abcfa567) Thanks [@greydragon888](https://github.com/greydragon888)! - the option validators judge a bag by its prototype ([#2217](https://github.com/greydragon888/real-router/issues/2217))
  ...
  beside the three this file already captured ([#1971](https://github.com/greydragon888/real-router/issues/1971)). The previous form resolved
...
- [#2056](https://github.com/greydragon888/real-router/pull/2056) [`e4ab941`](https://github.com/greydragon888/real-router/commit/e4ab9411344b86996f069e2186a8c9a10303f54a) Thanks [@greydragon888](https://github.com/greydragon888)! - Core's limit defaults are mirrored once, and the mirror is pinned ([#1879](https://github.com/greydragon888/real-router/issues/1879))
  ...
  three were local copies carrying the comment _"@real-router/types is not a direct
  dependency of this package"_ — `@real-router/core` is one, and publishes all
  ...
  `plugin ⊇ core` false-reject of [#1224](https://github.com/greydragon888/real-router/issues/1224) / [#1225](https://github.com/greydragon888/real-router/issues/1225), and it is now a TS2741 at the
  table instead.
...
> ⚠ **Never published** — there is no `0.15.2` on npm and no git tag for it. The release run that allocated this number never reached the registry; the entries below ship in **0.16.0**.
...
> ⚠ **Never published** — there is no `0.13.26` on npm and no git tag for it. The release run that allocated this number never reached the registry; the entries below ship in **0.13.27**.
