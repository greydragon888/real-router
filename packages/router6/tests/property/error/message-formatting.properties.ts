...
import type { ErrorCodeKeys } from "router6-types";
...
describe("RouterError Message Formatting Properties", () => {
  ...
  describe("Custom messages", () => {
    ...
    test.prop(
      ...
      (code, unicode) => {
        ...
        expect(err.message.length).toBe(unicode.length);
  ...
  describe("Message length and structure", () => {
    ...
    test.prop(
      ...
      expect(err.message.length).toBe(longMsg.length);
  ...
  describe("Edge cases", () => {
    ...
    test("very long stack trace does not affect code", () => {
  ...
  describe("Specific error code properties", () => {
    test("all standard error codes have informative messages", () => {
