...
const resolveStartState = <Dependencies extends DefaultDependencies>(
  ...
  // See: https://github.com/greydragon888/router6/issues/42
  try {
...
// See: https://github.com/greydragon888/router6/issues/44
...
export function withRouterLifecycle<Dependencies extends DefaultDependencies>(
  ...
  router.start = (...args: StartRouterArguments): Router<Dependencies> => {
    ...
    const protectedDone = (err?: RouterError, state?: State) => {
      if (callbackInvoked) {
        console.warn("Callback already invoked");
    ...
    //
    // See: https://github.com/greydragon888/router6/issues/50
    ...
    // See: https://github.com/greydragon888/router6/issues/43
    if (startState) {
